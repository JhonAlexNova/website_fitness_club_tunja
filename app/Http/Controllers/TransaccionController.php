...
{
    /** @var TransaccionRepository $transaccionRepository*/
    ...
    {
        $facturas = Factura::orderBy("id","desc")->whereIn("estado",["APPROVED",'PENDING',"REJECTED"])->get();
        ...
        return view('facturas.index',$backpack);
    }

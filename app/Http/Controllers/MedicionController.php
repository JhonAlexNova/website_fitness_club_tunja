...
class MedicionController extends AppBaseController
{
    ...
    {
        $medicions = $this->medicionRepository->all();

        return view('medicions.index')
            ->with('medicions', $medicions);
    }
    ...
    public function store(CreateMedicionRequest $request)
    {
        ...
        Flash::success('Medicion saved successfully.');

!function() {
        ...
        9774: function(e, n, t) {
            ...
            var s = function() {
                function e(n) {
                    ...
                    c = n.onSpinStart,
                    l = n.onSpinEnd,
                    d = n.onNameListChanged; ! function(e, n) {
                        if (! (e instanceof n)) throw new TypeError("Cannot call a class as a function")
                    } (this, e),
                    this.nameList = [],
                    this.havePreviousWinner = !1,
                    this.reelContainer = document.querySelector(s),
                    this.maxReelItems = o,
                    this.shouldRemoveWinner = u,
                    this.onSpinStart = c,
                    this.onSpinEnd = l,
                    this.onNameListChanged = d,
                    this.reelAnimation = null === (t = this.reelContainer) || void 0 === t ? void 0 : t.animate([{
                        transform: "none",
                        filter: "blur(0)"
                    },
                    {
                ...
                (t = [{
                    ...
                    set: function(e) {
                        var n;
                        this.nameList = e,
                        ((null === (n = this.reelContainer) || void 0 === n ? void 0 : n.children) ? Array.from(this.reelContainer.children) : []).forEach((function(e) {
                            return e.remove()
                        })),
                        this.havePreviousWinner = !1,
                    ...
                    value: (o = regeneratorRuntime.mark((function n() {
                        ...
                        return regeneratorRuntime.wrap((function(n) {
                            ...
                            case 0:
                                ...
                                return console.error("Name List is empty. Cannot start spinning."),
                                n.abrupt("return", !1);
                            case 3:
                            ...
                            case 7:
                                ...
                                return a = a.slice(0, this.maxReelItems - Number(this.havePreviousWinner)),
                                ...
                                t.appendChild(u),
                                o && this.nameList.splice(this.nameList.findIndex((function(e) {
                            ...
                            case 18:
                                return r.finish(),
                                Array.from(t.children).slice(0, t.children.length - 1).forEach((function(e) {
                                    return e.remove()
                                })),
            ...
            var f = function() {
                function e() {
                    ...
                    l(this, e),
                    (window.AudioContext || window.webkitAudioContext) && (this.audioContext = new(window.AudioContext || window.webkitAudioContext)),
                    this.isMuted = n
                }
                var n, t;
                return n = e,
                    ...
                    value: function(e) {
                        ...
                        if (s) {
                            ...
                            m = e.reduce((function(e, n) {
                                var t = n.key,
                                r = n.duration;
                                return l.frequency.setValueAtTime(c[t], f + e),
                                e + r
                            }), 0);
                            o && (d.gain.exponentialRampToValueAtTime(u, f + m - .1), d.gain.exponentialRampToValueAtTime(.01, f + m)),
                            l.start(f),
                            l.stop(f + m)
                        }
                    }
            ...
            function h(e) {
                ...
                m = document.getElementById("remove-from-list"),
                v = document.getElementById("enable-sound");
                
                if (e && n && t && i && o && a && u && c && l && d && m && v) if (l instanceof HTMLCanvasElement) {
                    var p, y = new f,
                    ...
                    k = new s({
                        ...
                        onSpinEnd: function() {
                            var n = h(regeneratorRuntime.mark((function n() {
                                return regeneratorRuntime.wrap((function(n) {
                                    for (;;) switch (n.prev = n.next) {
                                    case 0:
                                        return w(),
                        ...
                        var e = h(regeneratorRuntime.mark((function e() {
                            ...
                            return regeneratorRuntime.wrap((function(e) {
                                ...
                                case 2:
                                    ...
                                    n.text();
                                case 5:
                                    for (t = e.sent, r = t.split("\n"), i = 0; i < r.length; i++) k.names.push(r[i]);
                                case 8:
                                    case "end":
                                    return e.stop()
                                }
                    ...
                    var E = function() {
                        d.value = k.names.length ? k.names.join("\n") : "",
                        m.checked = k.shouldRemoveWinnerFromNameList,
                        v.checked = !y.mute,
                    ...
                    e.addEventListener("click", (function() {
                        k.names.length ? k.spin() : E()
                    })),
                    document.documentElement.requestFullscreen && document.exitFullscreen || n.remove(),
                    ...
                    a.addEventListener("click", (function() {
                        k.names = d.value ? d.value.split(/\n/).filter((function(e) {
                            return Boolean(e.trim())
                        })) : [],
                        k.shouldRemoveWinnerFromNameList = m.checked,
                        y.mute = !v.checked,
                        x()
                    })),
    ...
    function() {
        ...
        r = function() {},
        i = function(i, o) {
            for (var a, u, s = o[0], c = o[1], l = o[2], d = o[3], f = 0, m = []; f < s.length; f++) u = s[f],
            t.o(e, u) && e[u] && m.push(e[u][0]),
            e[u] = 0;
            for (a in  c) t.o(c, a) && (t.m[a] = c[a]);
            for (l && l(t), i && i(o); m.length;) m.shift()();
            return d && n.push.apply(n, d),
            r()
        },
        ...
        function a() {
            ...
            return 0 === n.length && (t.x(), t.x = function() {}),
            r
        }

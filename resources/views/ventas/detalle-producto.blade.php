    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-sm-6">
                ...
                {!! Form::number('cantidad', 1, ['class' => 'form-control cantidad_compra',  'required'=>true, "value"=>'1']) !!}
            </div>

            
            <div class="form-group col-sm-12">
               <button type='button' class='btn btn-primary btnAgregarProductoCarrito {{is_null($cierreGlobal->fecha_fin) && !is_null($cierreGlobal->cierre_caja)?"disabled":""}}'>Agregar</button>
            </div>

    ...
    <div class="card-body">
        <div class="row">
            <div class="form-group col-sm-12">
                <div class="foto">
                    <img src="" class='img-producto' alt="">
                </div>
            </div>
          ...
          {{--  <div class="form-group col-sm-6">
            ...
            <div class="form-group col-sm-6">
                ...
                {!! Form::number('cantidad_disponible', null, ['class' => 'form-control',  'required'=>true,  'disabled'=>true]) !!}
            </div>
            ...
            <div class="form-group col-sm-12">
               <button type='button' class='btn btn-primary btnAgregarProductoSalida'>Confirmar salida producto</button>
            </div>
